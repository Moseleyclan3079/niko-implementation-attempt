...
function JackensteinSoul:init(x,y,color)
    ...
    self.sprite:setSprite("player/"..Game:getSoulPartyMember():getSoulFacing().."/heart_dodge_small")
    self.outline:setSprite("player/"..Game:getSoulPartyMember():getSoulFacing().."/heart_invert_small")
    self.sprite_focus:setSprite("player/"..Game:getSoulPartyMember():getSoulFacing().."/heart_dodge_small_focus")
    self.collider = CircleCollider(self, 0, 0, 3)
    self.graze_sprite.texture = Assets.getTexture("player/"..Game:getSoulPartyMember():getSoulFacing().."/graze_small")
